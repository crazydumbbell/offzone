...
class OnboardingNookTest {
    ...
    @Test fun twelveNookExpressionsDecodeWithAlpha() {
        val context=InstrumentationRegistry.getInstrumentation().targetContext
        assertEquals(12,NookExpression.entries.size)
        NookExpression.entries.forEach { expression ->
